...
'==================================================================================================
' frmSubclass - A template form so that you can subclass without other files or dependencies.
'
...
Private Sub Form_Load()
  'Start subclassing whichever window handle we're interested in
  Call Subclass_Start(Me.hWnd)
  
  'Add the messages that we're interested in
  'Call Subclass_AddMsg(Me.hWnd, WM_?????, MSG_AFTER)
End Sub

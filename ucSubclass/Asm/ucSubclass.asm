;ucWindow.ctl model assembler source
...
_no_ide:    ;Before, original and after processing
...
_callback   ;Callback, edx indicates before or after (-1 or 0, True or False)
    ...
    js      _call                       ;Entry count is negative, all messages callback to the first public method on the UserControl
...
_call:      ;Callback to the first public method in the UserControl
    ...
    call    dword [eax+7A4h]            ;Call the first public method in the UserControl
_skip:    
    ret

;frmSubclass.frm model assembler source
...
_callback   ;Callback, edx indicates before or after (-1 or 0, True or False)
    ...
    js      _call                       ;Entry count is negative, all messages callback to the forms first public method
...
_call:      ;Callback to the first public method in the Form
    ...
    call    dword [eax+6F8h]            ;Call the first public method in the Form
_skip:    
    ret
